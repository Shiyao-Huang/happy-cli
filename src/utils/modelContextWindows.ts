...
export const MODEL_CONTEXT_WINDOWS: Record<string, number> = {
    ...
    'claude-opus-4-5': DEFAULT_CLAUDE_CONTEXT_WINDOW_TOKENS,
    ...
    'claude-sonnet-4-5': DEFAULT_CLAUDE_CONTEXT_WINDOW_TOKENS,
    ...
    'claude-haiku-4-5': DEFAULT_CLAUDE_CONTEXT_WINDOW_TOKENS,
};
