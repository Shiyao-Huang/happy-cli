...
```
https://github.com/slopus/aha-cli/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22
```
...
1. ⭐ **Star** 这个项目
2. 🍴 **Fork** 到你的账号
3. 💻 选择一个 [Issue](https://github.com/slopus/aha-cli/issues) 开始
...
[Start Contributing](https://github.com/slopus/aha-cli/issues) •
