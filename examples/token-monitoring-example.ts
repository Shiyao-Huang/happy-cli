...
import { createMonitoredQuery, getTokenMonitor, getModelManager } from '../dist/claude/sdk/index.js'
...
async function example3RealTimeMonitoring() {
    ...
    topModels.forEach((model, index) => {
        console.log(`  ${index + 1}. ${model.model}: ${model.requestCount} req, $${model.totalCost.toFixed(4)}`)
    })
}
