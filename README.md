...
### Ultra-Simple Commands (Recommended)

- `ccglm` - Start GLM model session (yolo mode)
- `ccmm` - Start MiniMax model session (yolo mode)
- `cckimi` - Start Kimi model session (yolo mode)
- `ccglm --no` - Start GLM model session (normal mode)
- `ccmm --no` - Start MiniMax model session (normal mode)
- `cckimi --no` - Start Kimi model session (normal mode)
...
- `happy --to <model> --yolo` - Support reverse argument order (yolo mode)
...
```bash
ccglm                          # Start GLM session (yolo mode)
ccmm                           # Start MiniMax session (yolo mode)
cckimi                         # Start Kimi session (yolo mode)
ccglm --no                     # Start GLM session (normal mode)
ccmm --no                      # Start MiniMax session (normal mode)
cckimi --no                    # Start Kimi session (normal mode)
```
...
happy --yolo --to GLM          # Switch to GLM and start (yolo mode)
happy --to GLM --yolo          # Same as above (reverse order)
```
